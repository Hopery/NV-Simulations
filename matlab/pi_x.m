...
% Returns: desity matrix after sequence. For more info see 
% `Robust dynamical decoupling sequences for individual-nuclear-spin 
% addressing` paper.


function px = pi_x(t,rho,tau_f,tau)
global H_phase H_free
    ...
    rho_1 = time_evolution(H_phase(pi/6), t, rho_0);      
    rho_2 = time_evolution(H_free,tau_2,rho_1); 
    rho_3 = time_evolution(H_phase(0), t, rho_2);      
    rho_4 = time_evolution(H_free,tau_3,rho_3); 
    rho_5 = time_evolution(H_phase(pi/2), t, rho_4); 
    rho_6 = time_evolution(H_free,tau_3,rho_5); 
    rho_7 = time_evolution(H_phase(0), t, rho_6); 
    rho_8 = time_evolution(H_free,tau_2,rho_7); 
    rho_9 = time_evolution(H_phase(pi/6), t, rho_8); 
